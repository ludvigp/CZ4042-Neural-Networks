...
pylab.savefig('figure_2b_hiddenLayer1.png')
...
pylab.savefig('figure_2b_hiddenLayer2.png')
...
pylab.savefig('figure_2b_hiddenLayer3.png')
...
pylab.figure("inputs")
pylab.savefig("project2b31_inputImages")
pylab.figure("reconstructed")
pylab.savefig("project2b31_reconstructedImages")
pylab.figure("hiddenLayerActivation")
pylab.savefig("project2b31_hiddenLayerActivation")
