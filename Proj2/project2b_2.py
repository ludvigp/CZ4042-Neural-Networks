...
pylab.plot(range(training_epochs2), d)
pylab.xlabel('iterations')
pylab.ylabel('cross-entropy')
pylab.savefig('project2b2_ffn_crossEntropy.png')

pylab.figure("Test accuracy")
pylab.plot(range(training_epochs2), a)
pylab.xlabel('iterations')
pylab.ylabel('test accuracy')
pylab.savefig('project2b2_ffn_accuracy.png')
